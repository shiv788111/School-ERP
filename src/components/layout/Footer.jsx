...
const Footer = () => {
  const footerLinks = [
    ...
    },
    {
      title: "Company",
      links: [
        { label: "About ConnectSkool",  href: "/about" },
...
<a                
              ...
              <ul className="flex flex-col gap-3">
                {section.links.map((link) => (
                  <li key={link.label} className="relative inline-block w-fit">
                    ...
                    {/* pulse badge — sirf "Careers" pe */}
                    {link.pulse && (
                      <span className="absolute -top-1 -right-7 flex h-2 w-2">
                        {/* <span className="animate-ping absolute inline-flex h-full w-full rounded-full bg-[#F0970A] opacity-75" /> */}
                        {/* <span className="relative inline-flex rounded-full h-2 w-2 bg-[#F0970A]" /> */}
                      </span>
                    )}
                  </li>
                ))}
        ...
        <div className="flex flex-col md:flex-row justify-between items-center gap-3 text-sm">
          ...
          <div className="flex items-center gap-4">
            <Link
              href="/privacypolicy"
              className="text-white/50 hover:text-[#F0970A] transition-colors text-xs"
            >
              Privacy Policy
            </Link>
          ...
          <p className="text-white/50">
            Made with <span className="text-[#F0970A]">♥</span> for modern schools
          </p>
        </div>
      </div>
