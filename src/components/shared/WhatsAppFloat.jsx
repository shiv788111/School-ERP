...
// ─────────────────────────────────────────────────────────
const PHONE   = "919236788668"; // Country code + number (without +)
const MESSAGE = "Hi ConnectSkool, I would like to learn more about your School ERP solutions.";
const GIF_SRC = "/whatsappoopsticky.gif"; // Place your GIF inside the public folder

const CHAT_MESSAGES = [
  "👋 Welcome to *ConnectSkool ERP*!",
  "Simplify *Admissions, Fees, Attendance, and Results* — all in one smart school management platform. 🏫",
  "Book your *FREE Demo* today and discover how ConnectSkool can transform your school operations. 📞",
  "Connect Parents, Teachers, and Administrators seamlessly in one powerful system. Let’s get started! 🚀",
];
// ─────────────────────────────────────────────────────────
