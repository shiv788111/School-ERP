  ...
  return (
    ...
    >
      <div className="container-shell">
        ...
        >
          {/* Background Gradient */}
          <div className="absolute inset-0 bg-gradient-to-r from-[#1E4E6D] to-[#1E4E6D]/80" aria-hidden="true" />
          <div className="absolute top-0 right-0 w-96 h-96 bg-[#F0970A]/10 rounded-full blur-3xl" aria-hidden="true" />
            ...
            <div className="flex flex-col sm:flex-row gap-4 justify-center">
              <button
                ...
                className="group inline-flex items-center justify-center gap-2 px-8 py-4 
                           ...
                           focus:outline-none focus:ring-2 focus:ring-[#F0970A] focus:ring-offset-2 focus:ring-offset-[#1E4E6D]"
                aria-label="Get your free demo of ConnectSkool"
              >
                Get Your Free Demo
                <ArrowRight size={20} className="group-hover:translate-x-1 transition" aria-hidden="true" />
              </button>
              <Link
                href="/pricing"
                className="inline-flex items-center justify-center gap-2 px-8 py-4 
                           ...
                           focus:outline-none focus:ring-2 focus:ring-white focus:ring-offset-2 focus:ring-offset-[#1E4E6D]"
                aria-label="View ConnectSkool pricing plans"
              >
                View Pricing
