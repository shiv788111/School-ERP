    ...
    class Particle {
      ...
      draw() {
        ...
        if (this.size > 1.2) {
          ...
          ctx.fillStyle = `rgba(240,151,10,${this.opacity * 0.05})`;
          ctx.fill();
        }
      }
    }
...
function ShowcaseCard({ icon, title, desc, variant = 'side', delay = 1000 }) {
  ...
  const baseTransform = variant === 'mid' ? '-translate-y-2.5' : variant === 'left' ? '-rotate-[5deg] translate-y-4' : 'rotate-[5deg] translate-y-4';
    ...
    <>
      ...
      >
        ...
        <div className="relative z-[2] flex flex-col items-center w-full max-w-[920px]">
          ...
          {/* Subtitle */}
          <p className="fa3 max-w-[560px] mb-7" style={{ fontSize: 15, lineHeight: 1.75, color: 'rgba(255,255,255,0.5)', fontWeight: 400 }}>
            Manage academics, administration, and communication seamlessly with our all-in-one, cloud-based school ERP system designed for modern
            institutions.
          </p>
          ...
          <div className="fa5 flex gap-3 flex-wrap justify-center mb-8">
            ...
            <Link href="/demo">
              <span
                className="inline-block text-white text-[11px] font-bold tracking-[1.5px] uppercase rounded-[4px] cursor-pointer transition-all duration-300 hover:-translate-y-0.5"
                style={{ padding: '13px 36px', background: '#F0970A' }}
                onMouseEnter={(e) => {
                  e.currentTarget.style.background = '#FFB84D';
                  e.currentTarget.style.boxShadow = '0 8px 30px rgba(240,151,10,0.4)';
                }}
                onMouseLeave={(e) => {
                  e.currentTarget.style.background = '#F0970A';
            ...
            <Link href="/modules">
              <span
                className="inline-block text-[11px] font-semibold tracking-[1.5px] uppercase rounded-[4px] cursor-pointer transition-all duration-300"
                style={{
                  padding: '13px 36px',
                ...
                onMouseEnter={(e) => {
                  e.currentTarget.style.borderColor = '#F0970A';
                  e.currentTarget.style.color = '#F0970A';
                }}
                onMouseLeave={(e) => {
          ...
          {/* Trust line */}
          <p className="fa6 max-w-[480px]" style={{ fontSize: 11, color: 'rgba(255,255,255,0.28)', lineHeight: 1.7 }}>
            Trusted by schools to manage <span style={{ color: 'rgba(240,151,10,0.65)', fontWeight: 500 }}>students, staff, and operations</span>{' '}
